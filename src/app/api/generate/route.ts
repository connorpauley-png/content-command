...
Respond ONLY with valid JSON (no markdown):
{
  ...
  "pillar": "content pillar name if applicable"
    ...
    let parsed: { content: string; hashtags?: string[]; suggestedTime?: string; imagePrompt?: string; pillar?: string; contentType?: string }
    try {
    ...
    const post: Post = {
      ...
      contentType: (parsed.contentType as Post['contentType']) || 'photo',
      status: 'idea',
